...
export function sign_in(login, password){
    ...
    const token_url = 'https://dudishgo.pythonanywhere.com/api/token'
...
export function sign_up(login, password){
    ...
    const users_url = 'https://dudishgo.pythonanywhere.com/api/users/'
    const authorization_token = 'b2f04ed4d357ebeff90b2c94434b2a01315473ec'
...
export function get_projects(user_token){
    const projects_url = 'https://dudishgo.pythonanywhere.com/api/projects/'
    const header = {'Authorization': 'Token ' + user_token}
